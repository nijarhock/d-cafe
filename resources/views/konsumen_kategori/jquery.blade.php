...
$(document).ready(function() {
    $("#btnSave").click(function() {
        $.ajax({
            type: "post",
            url: "<?php echo url('/') ?>/konsumen_kategori/store",
            dataType: "json",
    ...
    $(".show").click(function() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('/') ?>/konsumen_kategori/show",
            dataType: "json",
            data: {id:id, _token: "<?php echo csrf_token() ?>"},
            success: function(result) {
                let text = "";
                text += "<tr><th>Nama</th><td>"+result.nama+"</td></tr>";
                text += "<tr><th>Diskon (%)</th><td>"+result.diskon+"</td></tr>";
    ...
    $(".hapus").click(function() {
        ...
        .then((willDelete) => {
            if(willDelete) {
                $.ajax({
                    type: "post",
                    url: "<?php echo url('/') ?>/konsumen_kategori/destroy",
                    dataType: "json",
                    data: {id:id, _token: "<?php echo csrf_token() ?>"},
                    success: function(result) {
                        if(result == "OK")
    ...
    $("#btnEdit").click(function() {
        $.ajax({
            type: "post",
            url: "<?php echo url('/') ?>/konsumen_kategori/update",
            dataType: "json",
            data: $("#formMovie").serialize(),
            success: function(result) {
                if(result == "OK")
